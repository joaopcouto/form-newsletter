  ...
  return (
    <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
      ...
      <div className="flex flex-col">
        ...
        <input type="email" placeholder="Insira seu melhor e-mail" className="rounded-lg py-2 px-2 text-sm placeholder:text-sm placeholder:text-stone-400" value={email} onChange={(e) => setEmail(e.target.value)}/>
        {errors?.email && 
      ...
      <div className="flex flex-col">
        <a href="#" className="text-xs underline mb-2">Leia os termos</a>
          <div className="flex gap-2 items-center">
            <input className="text-sm" type="checkbox" checked={agree} onChange={(e) => setAgree(e.target.checked)} />
